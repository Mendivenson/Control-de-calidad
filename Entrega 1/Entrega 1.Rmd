...
> Finalmente el momento en que más probablemente se dio el cambio en la media resultará del estimador

$\hat{\tau}_{MV} =  \underset{0 \leq t < T}{\text{argmax}} \left[(T - t) (\bar{\bar{X}}_{T,t} - \mu_0)^2\right]$ implementado en R así:
