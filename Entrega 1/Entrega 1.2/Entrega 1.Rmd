...
\small De esta forma, podemos concluir que la carta $\bar{X}$ tiene un comportamiento relativamente similar en cuanto a $ARL_0$. Sin embargo, a mayor cantidad de muestras, la carta parece tener un mejor comportamiento en general. Es decir, tarda más en dar una falsa alarma y emite una señal más rápido cuando hayan corrimientos de la media.
